...
<body>
  ...
  <?php if (isset($_GET['user_created'])){ ?>         
       <div class="alert alert-info text-center"> <strong> Usuário criado com sucesso, realize seu login!</strong> <button type="button" class="close" data-dismiss="alert" aria-label="Close">
  ...
  <div role="tabpanel" class="tab-pane fade in active" id="login">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-heading">
       ...
       <form method="POST" action="controller/control_login_user.php">
